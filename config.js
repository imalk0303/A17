...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["94784198085"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["94784198085"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["94784198085"];
global.OwnerName = process.env.OWNER_NAME || "HANSAMAL";
global.BotName = process.env.BOT_NAME || "CHUTY";
